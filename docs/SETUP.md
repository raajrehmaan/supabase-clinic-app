...
The app silently creates the first Admin account when the database is empty.
Use the private Admin login details agreed with the clinic owner.

Any account created without the private Admin creation code becomes Staff.
